...
class FLYJETCO_options {
  ...
  */
  public function create_admin_menu_page() {
    $this->plugin_options_page = add_options_page('FLYJETCO', 'FLYJETCO', 'manage_options', __FILE__, array( $this, 'render_plugin_options_page' ) );
  }

  public function render_plugin_options_page() {
    echo '<div id="FLYJETCO"></div>';
  }
...
$FLYJETCO_options = new FLYJETCO_options();
$FLYJETCO_options->init();